    ...
    <div className="home">
      <section className="hero hero-card">
        ...
        <h2 className="hero-role">
          Front End Developer | Technical Skills & Experience
        </h2>
        <p className="hero-tagline" style={{ marginBottom: "1.5rem" }}>
          Versatile and reliable professional with 3+ years of experience in
          customer support, food service, and sales. Certified in IT
          Fundamentals, with hands-on experience in modern web technologies and
          frameworks. Strong problem-solving skills, adaptability, and a
          commitment to learning and growth in technical roles.
        </p>
      </section>
      ...
      <section className="skills skills-card">
        ...
        <ul style={{ lineHeight: "1.7", fontSize: "1.08rem" }}>
          <li>
            IT Fundamentals Certificate (Goodwill Vocational School, 2020)
          </li>
      ...
      <section className="skills skills-card">
        ...
        <ul style={{ lineHeight: "1.7", fontSize: "1.08rem" }}>
          <li>
            <b>Front End Development (Persevere, April 2025)</b>
          </li>
          <li>
            <b>Back End Development (Persevere, Current)</b>
          </li>
        </ul>
      </section>
